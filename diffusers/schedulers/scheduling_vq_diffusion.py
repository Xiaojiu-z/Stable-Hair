...
class VQDiffusionScheduler(SchedulerMixin, ConfigMixin):
    ...
    def __init__(
        ...
        # By convention, the index for the face_hair_mask class is the last class index
    ...
    def log_Q_t_transitioning_to_known_class(
        ...
        if not cumulative:
            ...
            # aren't overwritten.
            #
            # `P(x_t!=face_hair_mask|x_{t-1=face_hair_mask}) = 0` and 0 will be the value of the last row of the onehot vector
            # if x_t is not masked
            #
            # `P(x_t=face_hair_mask|x_{t-1=face_hair_mask}) = 1` and 1 will be the value of the last row of the onehot vector
            # if x_t is masked
