...
class RePaintScheduler(SchedulerMixin, ConfigMixin):
    """
    `RePaintScheduler` is a scheduler for DDPM inpainting inside a given face_hair_mask.
    ...
    def step(
        ...
        Args:
            ...
            mask (`torch.FloatTensor`):
                The face_hair_mask where a value of 0.0 indicates which part of the original image to inpaint.
