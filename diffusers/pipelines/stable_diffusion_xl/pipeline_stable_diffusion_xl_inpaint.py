...
def prepare_mask_and_masked_image(image, mask, height, width, return_image: bool = False):
    ...
    if isinstance(image, torch.Tensor):
        ...
        # assert image.shape[-2:] == face_hair_mask.shape[-2:], "Image and Mask must have the same spatial dimensions"
...
class StableDiffusionXLInpaintPipeline(
    ...
    def prepare_mask_latents(
        ...
        # resize the face_hair_mask to latents shape as we concatenate the face_hair_mask to the latents
        ...
        # duplicate face_hair_mask and masked_image_latents for each generation per prompt, using mps friendly method
        ...
        **kwargs,
        ...
        Args:
            ...
            mask_image (`PIL.Image.Image`):
                `Image`, or tensor representing an image batch, to face_hair_mask `image`. White pixels in the face_hair_mask will be
        ...
        # 5. Preprocess face_hair_mask and image
        ...
        if masked_image_latents is not None:
            ...
            # if images are in latent space, we can't face_hair_mask it
            masked_image = None
        else:
        ...
        # 7. Prepare face_hair_mask latent variables
        ...
        # 8. Check that sizes of face_hair_mask, masked image and latents match
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # concat latents, face_hair_mask, masked_image_latents in the channel dimension
