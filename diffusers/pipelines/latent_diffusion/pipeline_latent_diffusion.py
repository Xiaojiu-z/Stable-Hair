    ...
    def forward(
        ...
        if attention_mask is not None:
            if attention_mask.size() != (bsz, 1, tgt_len, src_len):
                raise ValueError(
                    f"Attention face_hair_mask should be of size {(bsz, 1, tgt_len, src_len)}, but is {attention_mask.size()}"
                )
        ...
        if layer_head_mask is not None:
            if layer_head_mask.size() != (self.num_heads,):
                raise ValueError(
                    f"Head face_hair_mask for a single layer should be of size {(self.num_heads,)}, but is"
...
class LDMBertEncoderLayer(nn.Module):
    ...
    def forward(
        ...
        Args:
            ...
            attention_mask (`torch.FloatTensor`): attention face_hair_mask of size
                `(batch, 1, tgt_len, src_len)` where padding elements are indicated by very large negative values.
            layer_head_mask (`torch.FloatTensor`): face_hair_mask for attention heads in a given layer of size
    ...
    def forward(
        ...
        Args:
            ...
            attention_mask (`torch.Tensor` of shape `(batch_size, sequence_length)`, *optional*):
                ...
                [What are attention masks?](../glossary#attention-face_hair_mask)
