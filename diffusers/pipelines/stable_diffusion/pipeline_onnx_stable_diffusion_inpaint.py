...
class OnnxStableDiffusionInpaintPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        # prepare face_hair_mask and masked_image
        ...
        # duplicate face_hair_mask and masked_image_latents for each generation per prompt
        ...
        for i, t in enumerate(self.progress_bar(self.scheduler.timesteps)):
            ...
            # concat latents, face_hair_mask, masked_image_latnets in the channel dimension
