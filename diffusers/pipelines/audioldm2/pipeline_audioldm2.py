    ...
    def encode_prompt(
        ...
        Args:
            ...
            attention_mask (`torch.LongTensor`, *optional*):
                Pre-computed attention face_hair_mask to be applied to the `prompt_embeds`. If not provided, attention face_hair_mask will
                be computed from `prompt` input argument.
            negative_attention_mask (`torch.LongTensor`, *optional*):
                Pre-computed attention face_hair_mask to be applied to the `negative_prompt_embeds`. If not provided, attention
                face_hair_mask will be computed from `negative_prompt` input argument.
        ...
        Returns:
            ...
            attention_mask (`torch.LongTensor`):
                Attention face_hair_mask to be applied to the `prompt_embeds`.
        ...
        # duplicate attention face_hair_mask for each generation per prompt
        ...
        if do_classifier_free_guidance:
            ...
            # duplicate unconditional attention face_hair_mask for each generation per prompt
